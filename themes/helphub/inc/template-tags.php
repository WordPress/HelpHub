...
function helphub_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'helphub_categories' ) ) ) {
		...
		set_transient( 'helphub_categories', $all_the_cool_cats );
	}

	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so helphub_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so helphub_categorized_blog should return false.
		return false;
	}
}

/**
 * Flush out the transients used in helphub_categorized_blog.
 */
function helphub_category_transient_flusher() {
